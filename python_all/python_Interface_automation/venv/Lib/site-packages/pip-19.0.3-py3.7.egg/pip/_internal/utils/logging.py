...
def setup_logging(verbosity, no_color, user_log_file):
    ...
    handler_classes = {
        "stream": "pip._internal.es_utils.logging.ColorizedStreamHandler",
        "file": "pip._internal.es_utils.logging.BetterRotatingFileHandler",
    }
    ...
    logging.config.dictConfig({
        ...
        "filters": {
            "exclude_warnings": {
                "()": "pip._internal.es_utils.logging.MaxLevelFilter",
